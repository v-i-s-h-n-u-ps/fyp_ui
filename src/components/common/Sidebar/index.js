        ...
        <>
            ...
            <aside id={`sideNav`} className={`${s.aside} ${!!navOpen ? s.open : ''} aside`}>
                <nav className={`${s.sidebar}`} >
                    ...
                    <div className={`${s.linkContainer} ${s.theme}`} onClick={() => { changeTheme() }}>
                        <div className={`${s.iconContainer}`}>
                            <i className={`${s.icon} icon-theme ${s.theme}`} />
                        </div>
                        <div className={`${s.link}`}>{otherLinks['theme'][theme]['text']}</div>
                    </div><div onClick={() => { setNavOpen(false); d__logout() }} className={`${s.linkContainer}`} >
                        <div className={`${s.iconContainer}`}>
