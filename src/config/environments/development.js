...
export const AMAZON_REGION = "ap-south-1";
export const GOOGLE_MAPS_KEY = "AIzaSyDYji12zyrIi8H0r-XDdbK0C9qBsElFadU";
export const TALKJS_APP_ID = "tDRyQI23";
export const TALKJS_SECRET_KEY = "sk_test_cqMb6KwbBu27lCbAVf9s5R8zab3wE3Xg"
